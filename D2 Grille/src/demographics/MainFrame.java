...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		if(jTextField1.getText().matches("[0-9]+") && jTextField2.getText().matches("[0-9]+")) {
			drawPanel1.setRows(Integer.parseInt(jTextField1.getText()));
			drawPanel1.setCols(Integer.parseInt(jTextField2.getText()));
		}
		repaint();
