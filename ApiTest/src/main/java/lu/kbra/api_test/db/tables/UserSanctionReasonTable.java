...
public class UserSanctionReasonTable extends DataBaseTable<UserSanctionReasonData> {
	...
	public static UserSanctionReasonData byId(int id) {
		UserSanctionReasonData usrd = UserSanctionReasonTable.TABLE.query(UserSanctionReasonData.byId(id))
				.thenApply(MULTI_MAP)
				.catch_(UserSanctionReasonTable::logErr)
				.run();
		return usrd;
	}

	public static UserSanctionReasonData byKey(String key) {
		UserSanctionReasonData usrd = UserSanctionReasonTable.TABLE.query(UserSanctionReasonData.byKey(key))
				.thenApply(MULTI_MAP)
				.catch_(UserSanctionReasonTable::logErr)
				.run();
		return usrd;
